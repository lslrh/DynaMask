...
from .dynamask_roi_head import DynaMaskRoIHead
...
__all__ = [
    ...
    'PointRendRoIHead', 'MaskPointHead', 'CoarseMaskHead', 'DynamicRoIHead', 'RefineRoIHead',  'PointRefineRoIHead', 'DynaMaskRoIHead'
]
