...
class SFMStage(nn.Module):
    ...
    def forward(self, instance_feats, semantic_feat, rois, roi_labels, cfg):
        ...
        instance_preds = instance_preds.view(num_rois, self.num_classes, -1)
        detail_preds = detail_preds.view(num_rois, self.num_classes, -1)
        ...
        instance_preds = instance_preds.view(num_rois, channels, mask_height, mask_width)
        detail_preds = detail_preds.view(num_rois, channels, mask_height, mask_width)
