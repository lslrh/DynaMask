...
class RefineMaskHead(nn.Module):
    ...
    def __init__(self,
        ...
        for idx, out_size in enumerate(self.stage_sup_size[:-1]):
            ...
            new_stage = SFMStage(
                ...
                semantic_out_stride=semantic_out_stride[idx],
    ...
    def forward(self, instance_feats, semantic_feats, rois, roi_labels):
        ...
        for idx, stage in enumerate(self.stages):
            ...
            instance_preds, detail_preds, instance_feats = stage(instance_feats, semantic_feats[-idx-1], rois, roi_labels, upsample_flag)
