...
class SFMStage(nn.Module):
    ...
    def forward(self, instance_feats, semantic_feat, rois, roi_labels, cfg):
        ...
        coarse_point_instance_feats = torch.gather(instance_logits, 2, point_indices.detach())
        coarse_point_detail_feats = torch.gather(detail_logits, 2, point_indices.detach())
